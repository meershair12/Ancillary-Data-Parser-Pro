...
export default function FloatingDeleteBar({
  setSelectedIds,
  isSelect = false,
  setIsSelect,
  handleDelete,
    ...
    <Fade in={isSelect}>
      ...
      >
        ...
        >
          ...
          <Box sx={{ px: 3, display: "flex", alignItems: "center", gap: 2 }}>
            <Box
              sx={{
                bgcolor: "#0073EA", // Monday blue
                color: "white",
                minWidth: "24px",
                height: "24px",
                borderRadius: "4px",
          ...
          <Box sx={{ px: 1, display: "flex", alignItems: "center", gap: 1 }}>
            <Button
              ...
              startIcon={isDeleting ? <CircularProgress size={16} color="inherit" /> : <TrashIcon size={18} />}
              sx={{
                color: "#ff4d4d",
                textTransform: "none",
                fontWeight: 600,
